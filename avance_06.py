# GESTOR DE NOTAS ACADÉMICAS - PROYECTO FINAL MEJORADO
# ==============================================================================
# IMPORTACIONES
# ==============================================================================
import json # Para guardar y cargar datos (persistencia)
import csv  # Para exportar los datos a formato CSV
...
def buscar_curso_binaria():
    ...
    # Se recomienda usar la opción 9 primero para que la lista principal esté ordenada.
...
def exportar_a_csv():
    """NUEVA FUNCIONALIDAD: Exporta la lista de cursos a un archivo CSV."""
...
def main():
    ...
    # NUEVA FUNCIONALIDAD: Cargar datos al iniciar
    cargar_datos()
    ...
    while opcion != 14: # Actualizado para la nueva opción de salida
        ...
        try:
            ...
            opciones = {
                ...
                13: exportar_a_csv # Nueva opción
            }
            
            if opcion in opciones:
                opciones[opcion]()
            elif opcion == 14: # Actualizado para la nueva opción de salida
                # NUEVA FUNCIONALIDAD: Guardar datos antes de salir
                guardar_datos()
